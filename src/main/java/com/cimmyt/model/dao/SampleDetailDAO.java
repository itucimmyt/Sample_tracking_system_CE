...
public interface SampleDetailDAO {
	...
	public List<SampleDetail> getSamplesByLocation(final Integer locationId, Integer firstResult, Integer maxResults
	...
	public List<SampleDetail> getCustomQuery (List<DsSearchParam> params, final int firstResult, final int maxResults);
